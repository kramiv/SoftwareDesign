...
void {//if just starting, it idrectly puts numbers in. Else, it reads from global mem.
    Hero Player;
    creature e1;
    creature e2;
    creature e3;
...
//that it needs to start now. just_starting is false. 
          SetUpRoom();//change state from inside of this fucntion
          //using state variable.
//change state != '5'. change it to '3'.
        }
        if ('6' == state) {
          std::cerr << "upgrades shop yaml";
          state = '3';
        }
