...
std::string fname = "data.txt";//create fname for file stream
std::ifstream f(fname.c_str());//
std::string t;//create t: first column of data.txt
while (f >> t) {//while f is reading into varialbe t from data.txt
